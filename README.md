...
However, a darkpoold configuration file looks like this:
...
* Broadcast
	...
	Note: for some users darkpoold has trouble parsing spaces in the `--text` argument. One workaround is to
